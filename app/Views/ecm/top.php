...
<html lang="en">
   <head>
      ...
      <!-- font awesome -->
      <link rel="stylesheet" type="text/css" href="<?= base_url()?>https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
      <!--  -->
      <!-- owl stylesheets -->
      <link href="<?= base_url()?>https://fonts.googleapis.com/css?family=Great+Vibes|Poppins:400,700&display=swap&subset=latin-ext" rel="stylesheet">
